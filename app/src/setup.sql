...
tools:
  ...
  - tool_spec:
      type: "generic"
      name: "text_to_cypher"
      description: "Generate FalkorDB Cypher from a natural-language graph question using Snowflake Cortex and graph schema context. Use this before run_cypher for complex graph questions."
      input_schema:
        type: "object"
        properties:
          input_agent_name:
